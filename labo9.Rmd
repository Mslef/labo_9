...
ad_res <- lapply(model_list, function(x) ad.test(residuals(x)))
names(ad_res) <- names
ad_res
...
Nous représentons finalement l'impact des coefficients calculés par inférence multimodèle sur le gain de masse :
